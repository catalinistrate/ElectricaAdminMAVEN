	...
	public void Run()
	{
		...
		while(cmd!=0)
		{
			...
			{								
				...
				String result = ctrl.AddClient(name, address, id);
				if (result != null) {
			...
			if(cmd==2)
			{
				...
				String result = ctrl.AddClientIndex(c, year, month, sumToPay);
				if (result != null) {
					System.out.println(result);
				} else {
					System.out.println("The index was successfully added");
				}
